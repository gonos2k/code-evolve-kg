...
from codeevolve.utils.graphify_export import validate_exportable_knowledge_links
...
def _validate_graphify_export_config(config: Dict[str, Any]) -> None:
    ...
    validate_exportable_knowledge_links(knowledge_links, key="GRAPHIFY_EXPORT.knowledge_links")
